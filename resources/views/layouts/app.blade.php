...
<head>
    ...
    <div x-data="{ sidebarOpen: false }" x-cloak>
        <div class="flex min-h-screen">
            ...
            @auth
                <!-- regular sidebar -->
                <div class="sidebar hidden flex-none w-full md:block md:w-60 px-4 bg-primary ">
                    @include('layouts.navigation')
                </div>

                <!--sidebar on mobile-->
                <div x-show="sidebarOpen" class="sidebar min-w-full px-4 bg-primary md:hidden">
                    @include('layouts.navigation')
                </div>
            @endauth
        ...
        <div class="bg-primary  dark:text-gray-300 p-5 flex justify-between text-xs">
